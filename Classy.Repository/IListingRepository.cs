...
namespace Classy.Repository
{
    ...
    public interface IListingRepository
    {
        ...
        IList<Listing> Search(string[] tags, string[] categories, string[] listingTypes, IDictionary<string, string[]> metadata, IDictionary<string, string[]> query, double? priceMin,
