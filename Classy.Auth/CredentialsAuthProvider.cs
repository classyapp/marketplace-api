...
namespace Classy.Auth
{
    public class CredentialsAuthProvider : AuthProvider
    {
        ...
        public virtual bool TryAuthenticate(IServiceBase authService, string appId, string userName, string password)
        {
            ...
            if (authRepo.TryAuthenticate(appId, userName, password, out userAuth))
            {
        ...
        {
            var userSession = session as CustomUserSession;
            if (userSession != null)
            {
